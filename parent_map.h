...
extern "C" {
    ...
    typedef struct parent_map distance_map;
...
#endif	/* #ifndef COM_GITHUB_CODERODDE_BIDIR_SEARCH_DISTANCE_MAP_H
...
#endif	/* COM_GITHUB_CODERODDE_BIDIR_SEARCH_PARENT_MAP_H */
